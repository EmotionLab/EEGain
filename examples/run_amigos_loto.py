...
main_loto(dreamer_dataset, model)
...
#     eegloader = EEGDataloader(dreamer_dataset, batch_size=32).loto(subject_id, session_ids, n_fold=len(
#         session_ids))  # pass n_fold=len(session_ids) for LOTO
#     num_epoch = 5
